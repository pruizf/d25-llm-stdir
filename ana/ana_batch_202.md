...
## 1010 || match
  ...
  - XPL: La didascalie 'Frappant sur la table' décrit une action physique réalisée par un personnage. Cette action n'est pas spécifiquement liée à une interaction non verbale avec d'autres personnages, ni à une entrée ou sortie de scène, ni à une manipulation d'objet. Elle ne correspond pas non plus à une agression violente. Par conséquent, elle est classée dans la catégorie générale des actions des personnages (action).

## 1047 || match
  - REF;PRD: action ; action
  - TXT: Il l'ouvre.
  - XPL: La didascalie 'Il l'ouvre' décrit une action générale d'un personnage, à savoir ouvrir quelque chose. Cette action n'est pas spécifiquement décrite par une autre catégorie plus précise, donc elle tombe dans la catégorie générale des actions.

## 1057 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Rodogine.
  - XPL: La didascalie 'Apercevant Rodogine' décrit une action du personnage qui regarde ou voit Rodogine. Cette action n'est pas couverte par une catégorie plus spécifique, donc elle tombe sous la catégorie générale 'action'.

## 1081 || match
  - REF;PRD: action ; action
  - TXT: Ils s'asseyent.
  - XPL: La didascalie 'Ils s'asseyent' décrit une action des personnages, à savoir s'asseoir. Cette action est couverte par la catégorie 'action' qui inclut des verbes comme s'asseoir.

## 1083 || match
  - REF;PRD: action ; action
  - TXT: Il regarde dans l'antichambre.
  - XPL: La didascalie 'Il regarde dans l'antichambre.' décrit une action simple du personnage sans interaction avec d'autres personnages ou objets. Elle ne correspond pas aux autres catégories spécifiques comme 'agression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, elle est classée dans la catégorie générale 'action'.

## 1096 || match
  - REF;PRD: action ; action
  - TXT: Elle fouille dans ses poches.
  - XPL: La didascalie 'Elle fouille dans ses poches' décrit une action générale du personnage. Le verbe 'fouiller' est une action qui peut être classée dans la catégorie 'action' (0), car elle ne correspond pas spécifiquement à une autre catégorie plus précise.

## 1099 || match
  - REF;PRD: action ; action
  - TXT: Il s'assied en un coin du théâtre.
  - XPL: La didascalie 'Il s'assied en un coin du théâtre.' décrit une action simple du personnage, qui est de s'asseoir. Cette action ne relève pas d'une catégorie plus spécifique comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle correspond donc à la catégorie générale 'action'.

## 1111 || match
  - REF;PRD: action ; action
  - TXT: Il grave quatre vers sur son tombeau qui seront lus par Amarille.
  - XPL: La didascalie décrit une action spécifique du personnage, à savoir graver des vers sur un tombeau. Cette action n'entre pas dans les catégories plus spécifiques telles que l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie générale des actions.

## 1112 || match
  - REF;PRD: action ; action
  - TXT: Ils s'asseyent tous.
  - XPL: La didascalie 'Ils s'asseyent tous.' décrit une action générale des personnages, à savoir s'asseoir. Cette action n'est pas spécifiquement liée à une autre catégorie plus précise, donc elle correspond à la catégorie 'action' (0).

## 1113 || match
  - REF;PRD: action ; action
  - TXT: Se levant.
  - XPL: La didascalie 'Se levant' décrit une action physique du personnage, qui est de se lever. Cette action ne rentre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1135 || match
  - REF;PRD: action ; action
  - TXT: Personne ne bouge.
  - XPL: La didascalie 'Personne ne bouge' décrit une action générale des personnages. Elle indique que les personnages ne font aucun mouvement, ce qui est une action en soi. Cette catégorie générale est appropriée car elle couvre les actions des personnages qui ne sont pas spécifiquement décrites par d'autres catégories.

## 1147 || match
  - REF;PRD: action ; action
  - TXT: Elle montre Racine.
  - XPL: La didascalie 'Elle montre Racine' décrit une action générale du personnage. Le verbe 'montrer' est explicitement mentionné comme faisant partie de la catégorie 'action'.

## 1151 || match
  - REF;PRD: action ; action
  - TXT: Après qu'il a lu.
  - XPL: La didascalie 'Après qu'il a lu' décrit une action générale du personnage, qui est de lire. Cette action n'entre pas dans une catégorie plus spécifique comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie 'action' (catégorie 0).

## 1161 || match
  - REF;PRD: action ; action
  - TXT: Il lit la lettre après quoi il dit.
  - XPL: La didascalie 'Il lit la lettre après quoi il dit' décrit une action simple du personnage, à savoir lire une lettre. Cette action n'implique pas de violence, d'interaction non verbale, de mouvement spécifique, de musique, de narration, d'objet manipulé de manière complexe, de description de lieu ou de destinataire de réplique. Elle correspond donc à la catégorie générale des actions des personnages.

## 1168 || match
  - REF;PRD: action ; action
  - TXT: Elle ouvre l'armoire.
  - XPL: La didascalie 'Elle ouvre l'armoire.' décrit une action simple d'un personnage, qui est d'ouvrir un objet. Cette action est couverte par la catégorie générale 'action' car elle ne correspond pas à une interaction spécifique avec un autre personnage, ni à une entrée ou sortie de scène, ni à une description d'objet ou de scène.

## 1171 || match
  - REF;PRD: action ; action
  - TXT: Il regarde dans un petit cabinet.
  - XPL: La didascalie 'Il regarde dans un petit cabinet' décrit une action du personnage. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 0 (action), ce qui en fait la catégorie la plus appropriée.

## 1188 || match
  - REF;PRD: action ; action
  - TXT: Elle pâme.
  - XPL: La didascalie 'Elle pâme' décrit une action du personnage, qui est de s'évanouir ou de perdre connaissance. Cette action est une action générale qui ne correspond pas spécifiquement à d'autres catégories plus précises comme 'aggression', 'aparte', 'delivery', etc. Elle tombe donc dans la catégorie générale des actions.

## 1203 || match
  - REF;PRD: action ; action
  - TXT: Apercevant l'appartement.
  - XPL: La didascalie 'Apercevant l'appartement' décrit une action générale du personnage, qui est de regarder ou observer l'appartement. Cette action ne rentre pas dans les catégories spécifiques comme 'aggression', 'aparte', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle correspond donc à la catégorie générale des actions.

## 1204 || match
  - REF;PRD: action ; action
  - TXT: Il s'assied sur le canapé.
  - XPL: La didascalie 'Il s'assied sur le canapé.' décrit une action générale du personnage, qui est de s'asseoir. Cette action n'entre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie 'action' (catégorie 0).

## 1208 || match
  - REF;PRD: action ; action
  - TXT: Lucile regarde toujours.
  - XPL: La didascalie 'Lucile regarde toujours' décrit une action simple du personnage Lucile, qui est de regarder. Cette action n'entre pas dans les catégories plus spécifiques comme l'entrée, la sortie, l'interaction, le mouvement, etc. Elle est donc classée dans la catégorie générale 'action' (0).

## 1250 || match
  - REF;PRD: action ; action
  - TXT: Lucile regarde.
  - XPL: La didascalie 'Lucile regarde' décrit une action du personnage Lucile. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 'action'. Cette catégorie est générale pour les actions des personnages et est utilisée lorsque d'autres catégories ne décrivent pas l'action.

## 1251 || match
  - REF;PRD: action ; action
  - TXT: La porte se rouvre.
  - XPL: La didascalie 'La porte se rouvre' décrit une action générale d'un objet (la porte) qui se rouvre. Cette action n'entre pas spécifiquement dans les autres catégories plus spécifiques telles que 'entrance', 'exit', 'interaction', ou 'movement'. Elle est donc classée dans la catégorie générale 'action' (catégorie 0).

## 1257 || match
  - REF;PRD: action ; action
  - TXT: Il se fouille.
  - XPL: La didascalie 'Il se fouille' décrit une action spécifique du personnage. Elle ne rentre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, elle correspond à la catégorie générale 'action' (catégorie 0).

## 1259 || match
  - REF;PRD: action ; action
  - TXT: Montrant Montval.
  - XPL: La didascalie 'Montrant Montval' décrit une action générale du personnage, qui est de montrer quelque chose ou quelqu'un. Cela correspond à la catégorie 'action' (0) car il s'agit d'une action spécifique réalisée par le personnage.

## 1269 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Amphitryon.
  - XPL: La didascalie 'Apercevant Amphitryon' décrit une action du personnage, à savoir apercevoir quelqu'un. Cette action n'entre pas dans les catégories plus spécifiques comme l'entrée, la sortie, l'interaction, ou le mouvement. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1290 || match
  - REF;PRD: action ; action
  - TXT: Après avoir bu.
  - XPL: La didascalie 'Après avoir bu' décrit une action spécifique d'un personnage, en l'occurrence l'action de boire. Cela correspond à la catégorie 'action' car elle décrit une action générale d'un personnage.

## 1293 || match
  - REF;PRD: action ; action
  - TXT: Elle lève la tête.
  - XPL: La didascalie 'Elle lève la tête' décrit une action simple et générale du personnage, sans impliquer d'autres catégories spécifiques comme l'entrée, la sortie, l'interaction ou le mouvement. Cela correspond à la catégorie 'action' (0).

## 1315 || match
  - REF;PRD: action ; action
  - TXT: Montval, lit.
  - XPL: La didascalie 'Montval, lit.' décrit une action simple du personnage Montval qui lit. Cette action n'entre pas dans les autres catégories spécifiques comme 'entrance', 'exit', 'interaction', etc. Par conséquent, elle est classée dans la catégorie générale 'action' (0).

## 1321 || match
  - REF;PRD: action ; action
  - TXT: Ses jambes fléchissent sous lui, mais il se redresse héroïquement.
  - XPL: La didascalie décrit une action du personnage, où ses jambes fléchissent et il se redresse héroïquement. Cette description correspond à la catégorie 'action', car elle décrit des actions physiques du personnage sans impliquer d'autres catégories plus spécifiques comme l'entrée, la sortie, l'interaction non verbale, ou le déplacement.

## 1344 || match
  - REF;PRD: action ; action
  - TXT: Elle continue.
  - XPL: La didascalie 'Elle continue' décrit une action générale du personnage. Elle ne correspond pas à une entrée ou sortie de scène, ni à une interaction non verbale, ni à une description de la voix ou de la musique. Elle ne décrit pas non plus un objet, une narration longue, ou une description de la scène. Par conséquent, elle relève de la catégorie 'action'.

## 1357 || match
  - REF;PRD: action ; action
  - TXT: En montrant ses jambes.
  - XPL: La didascalie 'En montrant ses jambes.' décrit une action spécifique du personnage. Cette action n'est pas couverte par une des autres catégories plus spécifiques comme 'aggression', 'entrance', 'exit', etc. Elle relève donc de la catégorie générale 'action'.

## 1359 || match
  - REF;PRD: action ; action
  - TXT: Il reste en contemplation.
  - XPL: La didascalie 'Il reste en contemplation' décrit une action du personnage. Elle ne correspond pas à une entrée, une sortie, une interaction non verbale, un mouvement, une narration, une description d'objet, ou une description de la scène. Elle ne décrit pas non plus une agression, un aparté, une manière de délivrer une réplique, ou un destinataire de réplique. Par conséquent, elle relève de la catégorie générale 'action'.

## 1363 || match
  - REF;PRD: action ; action
  - TXT: Il va ouvrir.
  - XPL: La didascalie 'Il va ouvrir' décrit une action simple et générale du personnage, à savoir ouvrir quelque chose. Cette action n'entre pas dans les catégories spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie 'action'.

## 1364 || match
  - REF;PRD: action ; action
  - TXT: Ils lisent.
  - XPL: La didascalie 'Ils lisent.' décrit une action des personnages, à savoir lire. Cette action ne rentre pas dans les autres catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Par conséquent, elle est classée dans la catégorie générale 'action' (catégorie 0).

## 1379 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Cléon.
  - XPL: La didascalie 'Apercevant Cléon' décrit une action du personnage qui consiste à voir ou apercevoir quelqu'un. Cela correspond à la catégorie 'action' (catégorie 0), car elle décrit une action générale d'un personnage sans entrer dans les détails des autres catégories.

## 1402 || match
  - REF;PRD: action ; action
  - TXT: Elle s'assied à gauche de la cheminée.
  - XPL: La didascalie 'Elle s'assied à gauche de la cheminée' décrit une action du personnage, en l'occurrence s'asseoir. Cette action est une action générale et ne rentre pas dans une catégorie plus spécifique comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle correspond donc à la catégorie 'action' (catégorie 0).

## 1426 || match
  - REF;PRD: action ; action
  - TXT: Il s'assied à table. Laforêt et de Brie vont et viennent par la porte du fond, et apportent une collation.
  - XPL: La didascalie 'Il s'assied à table. Laforêt et de Brie vont et viennent par la porte du fond, et apportent une collation.' décrit des actions générales des personnages, telles que s'asseoir et apporter une collation. Ces actions ne sont pas spécifiquement liées à une entrée, une sortie, une interaction non verbale, ou un autre type de catégorie plus spécifique. Par conséquent, la catégorie 'action' est la plus appropriée.

## 1430 || match
  - REF;PRD: action ; action
  - TXT: Corbineli fait le signe de la Croix.
  - XPL: La didascalie 'Corbineli fait le signe de la Croix' décrit une action spécifique du personnage, qui est de faire le signe de la Croix. Cette action ne rentre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle est donc classée dans la catégorie générale 'action' (catégorie 0).

## 1434 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Adélaïde.
  - XPL: La didascalie 'Apercevant Adélaïde' décrit une action du personnage, en l'occurrence le fait de voir ou de percevoir Adélaïde. Cette action ne correspond pas spécifiquement à une autre catégorie plus précise comme l'entrée, la sortie, l'interaction non verbale, le mouvement, etc. Elle relève donc de la catégorie générale des actions des personnages.

## 1435 || match
  - REF;PRD: action ; action
  - TXT: Elle se jette aux pieds de Saint-Albin.
  - XPL: La didascalie 'Elle se jette aux pieds de Saint-Albin' décrit une action spécifique du personnage. Bien que cela implique une interaction non verbale, l'action de se jeter aux pieds de quelqu'un est une action physique qui ne correspond pas spécifiquement à une interaction non verbale comme regarder, pointer du doigt, toucher, etc. Elle est donc mieux classée dans la catégorie générale 'action'.

## 1442 || match
  - REF;PRD: action ; action
  - TXT: Voyant Monsieur Raimond.
  - XPL: La didascalie 'Voyant Monsieur Raimond' décrit une action générale du personnage qui regarde Monsieur Raimond. Cette action n'est pas spécifiquement couverte par les autres catégories et correspond donc à la catégorie 'action' (catégorie 0).

## 1458 || match
  - REF;PRD: action ; action
  - TXT: Il se rassoit.
  - XPL: La didascalie 'Il se rassoit' décrit une action simple d'un personnage. Selon la définition de la catégorie 0 (action), cette catégorie est utilisée pour les actions générales des personnages lorsque d'autres catégories ne décrivent pas l'action. Le verbe 'se rasseoir' est bien un verbe d'action qui ne rentre pas dans les autres catégories spécifiques.

## 1473 || match
  - REF;PRD: action ; action
  - TXT: Il lit les requêtes.
  - XPL: La didascalie 'Il lit les requêtes' décrit une action simple du personnage, qui est de lire. Cette action ne rentre pas dans les autres catégories plus spécifiques comme l'agression, l'aparte, l'entrée, la sortie, etc. Par conséquent, elle correspond à la catégorie générale des actions.

## 1477 || match
  - REF;PRD: action ; action
  - TXT: Apercevant sa femme.
  - XPL: La didascalie 'Apercevant sa femme' décrit une action du personnage, qui est de voir ou de remarquer sa femme. Cette action ne tombe pas dans les catégories spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc., mais relève de la catégorie générale des actions des personnages.

## 1489 || match
  - REF;PRD: action ; action
  - TXT: Il s'appuie contre un arbre.
  - XPL: La didascalie 'Il s'appuie contre un arbre' décrit une action simple du personnage sans impliquer une interaction avec un autre personnage ou un mouvement spécifique. Elle rentre donc dans la catégorie 'action' qui est une catégorie générale pour les actions des personnages.

## 1491 || match
  - REF;PRD: action ; action
  - TXT: Il montre celle qui est sur le tombeau d'Artamon.
  - XPL: La didascalie 'Il montre celle qui est sur le tombeau d'Artamon' décrit une action du personnage qui montre quelque chose. Cette action correspond à la catégorie 'action' (catégorie 0), car elle décrit une action générale du personnage sans spécifier une interaction non verbale ou un mouvement spécifique.

## 1506 || match
  - REF;PRD: action ; action
  - TXT: Il ouvre le tiroir.
  - XPL: La didascalie 'Il ouvre le tiroir' décrit une action simple et générale du personnage. Le verbe 'ouvrir' est explicitement mentionné dans la définition de la catégorie 'action'. Aucune autre catégorie ne décrit mieux cette action.

## 1510 || match
  - REF;PRD: action ; action
  - TXT: En apercevant le Comte.
  - XPL: La didascalie 'En apercevant le Comte' décrit une action du personnage qui voit le Comte. Cela correspond à la catégorie 'action' (0), car il s'agit d'une action générale des personnages qui n'est pas couverte par une autre catégorie plus spécifique.

## 1518 || match
  - REF;PRD: action ; action
  - TXT: Montrant Milady.
  - XPL: La didascalie 'Montrant Milady' décrit une action générale d'un personnage, à savoir montrer quelqu'un. Cette action n'entre pas dans les catégories plus spécifiques comme l'entrée, la sortie, l'interaction non verbale, etc. Elle correspond donc à la catégorie 'action' (0).

## 1527 || match
  - REF;PRD: action ; action
  - TXT: Ouvrant la première lettre.
  - XPL: La didascalie 'Ouvrant la première lettre' décrit une action spécifique d'un personnage, qui est d'ouvrir une lettre. Cette action ne correspond pas à une catégorie plus spécifique comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle relève donc de la catégorie générale 'action'.

## 1529 || match
  - REF;PRD: action ; action
  - TXT: Montrant Criséis.
  - XPL: La didascalie 'Montrant Criséis' décrit une action du personnage qui montre Criséis. Cette action ne rentre pas dans les catégories spécifiques comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1530 || match
  - REF;PRD: action ; action
  - TXT: Montrant Frontin.
  - XPL: La didascalie 'Montrant Frontin' décrit une action générale du personnage, qui est de montrer quelque chose ou quelqu'un. Cela correspond à la catégorie 'action' (catégorie 0), car il s'agit d'une action spécifique du personnage qui n'entre pas dans les autres catégories plus spécifiques.

## 1547 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Dormene.
  - XPL: La didascalie 'Apercevant Dormene' décrit une action du personnage qui voit ou aperçoit quelqu'un. Cette action n'entre pas dans les catégories spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle relève donc de la catégorie générale 'action' (0).

## 1562 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Angélique.
  - XPL: La didascalie 'Apercevant Angélique' décrit une action du personnage qui voit quelqu'un. Cela correspond à la catégorie 'action' (0), car elle décrit une action générale des personnages qui n'est pas spécifiquement couverte par d'autres catégories.

## 1563 || match
  - REF;PRD: action ; action
  - TXT: Ayant l'air de chercher autour d'elle.
  - XPL: La didascalie 'Ayant l'air de chercher autour d'elle' décrit une action générale du personnage, qui est de chercher. Cela correspond à la catégorie 'action' car elle ne décrit pas une interaction non verbale, un déplacement spécifique, une entrée ou sortie, ni une interaction avec un objet. Le verbe 'chercher' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1579 || match
  - REF;PRD: action ; action
  - TXT: Continuant à lire.
  - XPL: La didascalie 'Continuant à lire' décrit une action simple et générale du personnage, qui est de lire. Cette action ne rentre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle est donc classée dans la catégorie 'action'.

## 1585 || match
  - REF;PRD: action ; action
  - TXT: Dorante, se jetant de nouveau à ses pieds.
  - XPL: La didascalie 'Dorante, se jetant de nouveau à ses pieds' décrit une action spécifique du personnage Dorante. Cette action ne correspond pas à une entrée ou sortie, ni à une interaction non verbale ou à une manipulation d'objet. Elle ne décrit pas non plus une agression, un aparté, une livraison de réplique, de la musique, une narration, un décor ou un destinataire de réplique. Elle correspond donc à la catégorie 'action' (0).

## 1587 || match
  - REF;PRD: action ; action
  - TXT: Il ouvre la porte et lit attentivement une carte de visite clouée à l'extérieur.
  - XPL: La didascalie 'Il ouvre la porte et lit attentivement une carte de visite clouée à l'extérieur' décrit des actions spécifiques du personnage, telles que ouvrir la porte et lire une carte de visite. Ces actions ne rentrent pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', ou 'movement'. Elles sont donc classées dans la catégorie générale 'action' (0).

## 1604 || match
  - REF;PRD: action ; action
  - TXT: Louis se lève.
  - XPL: La didascalie 'Louis se lève' décrit une action générale du personnage Louis. Cette action ne correspond pas à une entrée ou sortie de scène, ni à une interaction non verbale, ni à une description de la scène ou d'un objet. Elle ne fait pas non plus référence à une agression, un aparté, une narration, ou de la musique. Par conséquent, elle est classée dans la catégorie 'action' (catégorie 0).

## 1607 || match
  - REF;PRD: action ; action
  - TXT: Il appuie ses deux mains sur sa poitrine.
  - XPL: La didascalie 'Il appuie ses deux mains sur sa poitrine' décrit une action physique du personnage sans impliquer d'interaction avec d'autres personnages ou objets. Elle ne correspond pas aux autres catégories spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, la catégorie 'action' est la plus appropriée.

## 1622 || match
  - REF;PRD: action ; action
  - TXT: On entend dans la Chambre voisine, VAÎné qui appelle à lui en criant.
  - XPL: La didascalie 'On entend dans la Chambre voisine, VAÎné qui appelle à lui en criant.' décrit une action du personnage VAÎné qui appelle à lui en criant. Cette action n'entre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, la catégorie 'action' (0) est la plus appropriée.

## 1636 || match
  - REF;PRD: action ; action
  - TXT: D'une voix il fait marcher la sonnerie. Carillon chez le ministre.
  - XPL: La didascalie décrit une action spécifique du personnage, à savoir 'D'une voix il fait marcher la sonnerie', ce qui correspond à une action générale. De plus, 'Carillon chez le ministre' peut être interprété comme une conséquence de cette action. Ces éléments correspondent bien à la catégorie 'action'

## 1642 || match
  - REF;PRD: action ; action
  - TXT: Il frappe à une autre porte.
  - XPL: La didascalie 'Il frappe à une autre porte' décrit une action spécifique du personnage sans impliquer d'autres catégories plus spécifiques comme l'entrée, la sortie, ou l'interaction non verbale. Le verbe 'frapper' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1682 || match
  - REF;PRD: action ; action
  - TXT: Il tombe.
  - XPL: La didascalie 'Il tombe' décrit une action spécifique du personnage, qui est de tomber. Cette action est couverte par la catégorie 'action', qui inclut des verbes comme tomber.

## 1683 || match
  - REF;PRD: action ; action
  - TXT: Il signe.
  - XPL: La didascalie 'Il signe' décrit une action générale d'un personnage. 'Signe' est un verbe qui n'est pas spécifiquement couvert par les autres catégories plus précises, donc la catégorie 'action' est la plus appropriée.

## 1691 || match
  - REF;PRD: action ; action
  - TXT: Se jetant aux pieds de Wild.
  - XPL: La didascalie 'Se jetant aux pieds de Wild' décrit une action spécifique du personnage, qui est de se jeter aux pieds de quelqu'un. Cette action ne correspond pas à une entrée ou une sortie, ni à une interaction non verbale, ni à une agression, ni à une narration, ni à une manipulation d'objet. Elle décrit simplement une action physique du personnage, ce qui correspond à la catégorie 'action' (0).

## 1693 || match
  - REF;PRD: action ; action
  - TXT: Il regarde l'heure à sa montre.
  - XPL: La didascalie 'Il regarde l'heure à sa montre.' décrit une action simple d'un personnage. Le verbe 'regarder' est l'un des verbes mentionnés dans la définition de la catégorie 'action'.

## 1701 || match
  - REF;PRD: action ; action
  - TXT: Il entend La Marquise.
  - XPL: La didascalie 'Il entend La Marquise' décrit une action du personnage, en l'occurrence l'action d'entendre quelqu'un. Cette action n'est pas spécifiquement couverte par les autres catégories plus spécifiques, donc elle appartient à la catégorie générale 'action'.

## 1703 || match
  - REF;PRD: action ; action
  - TXT: Il se met à genoux devant elle.
  - XPL: La didascalie 'Il se met à genoux devant elle.' décrit une action spécifique du personnage, qui est de s'agenouiller. Cette action ne correspond pas directement à une entrée ou sortie de scène, ni à une interaction non verbale spécifique, ni à une description d'objet ou de décor. Elle ne relève pas non plus de l'agression, de l'aparté, de la narration, de la musique, ou de l'indication d'un destinataire de réplique. Par conséquent, elle s'intègre parfaitement dans la catégorie 'action' (catégorie 0).

## 1709 || match
  - REF;PRD: action ; action
  - TXT: Ils boivent tous trois.
  - XPL: La didascalie 'Ils boivent tous trois' décrit une action des personnages, qui est boire. Cette action n'est pas spécifiquement couverte par une autre catégorie plus précise, donc la catégorie 'action' (0) est la plus appropriée.

## 1714 || match
  - REF;PRD: action ; action
  - TXT: Il lit en parcourant.
  - XPL: La didascalie 'Il lit en parcourant' décrit une action du personnage, à savoir lire. Cette action ne rentre pas dans les autres catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Par conséquent, elle est classée dans la catégorie générale 'action' (catégorie 0).

## 1722 || match
  - REF;PRD: action ; action
  - TXT: Elle va ouvrir.
  - XPL: La didascalie 'Elle va ouvrir' décrit une action générale du personnage. Le verbe 'ouvrir' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1725 || match
  - REF;PRD: action ; action
  - TXT: Oronte s'endort.
  - XPL: La didascalie 'Oronte s'endort' décrit une action du personnage, à savoir s'endormir. Cette action n'entre pas dans une des catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', etc. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1728 || match
  - REF;PRD: action ; action
  - TXT: Après avoir lu la lettre.
  - XPL: La didascalie 'Après avoir lu la lettre' décrit une action spécifique du personnage, à savoir lire une lettre. Cette action n'est pas couverte par une autre catégorie plus spécifique, donc elle correspond à la catégorie générale des actions des personnages.

## 1731 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Monsieur Jourdain.
  - XPL: La didascalie 'Apercevant Monsieur Jourdain' décrit une action de perception visuelle du personnage. Cela correspond à la catégorie générale des actions des personnages, car elle n'entre pas spécifiquement dans les autres catégories plus précises.

## 1752 || match
  - REF;PRD: action ; action
  - TXT: Il va pour écouter à la porte.
  - XPL: La didascalie 'Il va pour écouter à la porte' décrit une action spécifique du personnage, qui est d'écouter à la porte. Cette action n'entre pas dans les catégories plus spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1755 || match
  - REF;PRD: action ; action
  - TXT: Après qu'elle a lu.
  - XPL: La didascalie 'Après qu'elle a lu' décrit une action générale du personnage, qui est l'acte de lire. Cette action ne tombe pas dans les catégories spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle décrit simplement une action du personnage, ce qui correspond à la définition de la catégorie 'action'.

## 1756 || match
  - REF;PRD: action ; action
  - TXT: Ils s'asseyent à la table.
  - XPL: La didascalie 'Ils s'asseyent à la table' décrit une action des personnages. Le verbe 's'asseoir' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1763 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Jean.
  - XPL: La didascalie 'Apercevant Jean' décrit une action générale du personnage, qui est de voir ou d'apercevoir quelqu'un. Cette action n'entre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle correspond donc à la catégorie générale des actions (action).

## 1797 || match
  - REF;PRD: action ; action
  - TXT: Montrant Mégatise.
  - XPL: La didascalie 'Montrant Mégatise' décrit une action du personnage qui montre quelque chose. Cette action ne rentre pas dans les catégories spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle correspond donc à la catégorie générale 'action' qui inclut des verbes comme 'montrer'.

## 1805 || match
  - REF;PRD: action ; action
  - TXT: Apercevant la Présidente.
  - XPL: La didascalie 'Apercevant la Présidente' décrit une action générale du personnage, qui est de voir ou de remarquer la Présidente. Cette action n'entre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle est donc classée dans la catégorie générale 'action'.

## 1809 || match
  - REF;PRD: action ; action
  - TXT: Lisant son mémoire.
  - XPL: La didascalie 'Lisant son mémoire' décrit une action spécifique du personnage, à savoir lire. Cette action n'est pas spécifiquement couverte par les autres catégories plus spécifiques, donc elle tombe sous la catégorie générale 'action'.

## 1814 || match
  - REF;PRD: action ; action
  - TXT: Ils s'asseyent tous les deux.
  - XPL: La didascalie 'Ils s'asseyent tous les deux' décrit une action des personnages. Le verbe 's'asseoir' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1817 || match
  - REF;PRD: action ; action
  - TXT: Il se jette à ses genoux.
  - XPL: La didascalie 'Il se jette à ses genoux' décrit une action spécifique d'un personnage. Cette action n'est pas couverte de manière plus spécifique par les autres catégories. Par exemple, elle n'est pas une agression, un aparté, une entrée, une sortie, une interaction non verbale, un mouvement, de la musique, une narration, une interaction avec un objet, une description de la scène, ou l'indication d'un destinataire d'une réplique. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 1835 || match
  - REF;PRD: action ; action
  - TXT: Le Comte sied dans un fauteuil.
  - XPL: La didascalie 'Le Comte sied dans un fauteuil' décrit une action simple du personnage, qui est de s'asseoir. Cette action n'entre pas dans les catégories spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc., mais elle correspond bien à la catégorie générale 'action' (0).

## 1836 || match
  - REF;PRD: action ; action
  - TXT: Rosa se relève.
  - XPL: La didascalie 'Rosa se relève' décrit une action générale du personnage Rosa. Bien que 'se relever' puisse être considéré comme un mouvement, il s'agit d'une action spécifique qui ne rentre pas dans les autres catégories plus précises comme 'entrance', 'exit', ou 'interaction'. Par conséquent, la catégorie 'action' est la plus appropriée.

## 1845 || match
  - REF;PRD: action ; action
  - TXT: Ayant lu.
  - XPL: La didascalie 'Ayant lu' décrit une action du personnage, en l'occurrence le fait d'avoir lu quelque chose. Cette action rentre dans la catégorie générale des actions des personnages, qui inclut des verbes comme lire, écrire, manger, dormir, etc.

## 1854 || match
  - REF;PRD: action ; action
  - TXT: Relevant la tête, et faisant semblant de s'essuyer les yeux.
  - XPL: La didascalie 'Relevant la tête, et faisant semblant de s'essuyer les yeux' décrit des actions spécifiques du personnage, telles que relever la tête et faire semblant de s'essuyer les yeux. Ces actions ne correspondent pas à une interaction non verbale avec d'autres personnages (catégorie 6), ni à un déplacement (catégorie 7), ni à une entrée ou sortie de scène (catégories 4 et 5). Elles ne décrivent pas non plus une émotion vocale ou une manière de parler (catégorie 3). Par conséquent, la catégorie 'action' (catégorie 0) est la plus appropriée pour cette didascalie.

## 1855 || match
  - REF;PRD: action ; action
  - TXT: Climène en action de se jeter aux pieds du Roi. Et Pamphilie, sa soeur aussi.
  - XPL: La didascalie 'Climène en action de se jeter aux pieds du Roi. Et Pamphilie, sa soeur aussi.' décrit une action spécifique des personnages (se jeter aux pieds). Cette action ne correspond pas exactement à une interaction non verbale (catégorie 6) ni à un déplacement (catégorie 7), mais plutôt à une action générale des personnages, ce qui correspond à la catégorie 'action' (catégorie 0).

## 1870 || match
  - REF;PRD: action ; action
  - TXT: Regardant à sa montre.
  - XPL: La didascalie 'Regardant à sa montre' décrit une action spécifique du personnage, qui est de regarder sa montre. Cette action ne tombe pas dans les catégories plus spécifiques comme 'agression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, elle est classée dans la catégorie générale 'action' (catégorie 0).

## 1871 || match
  - REF;PRD: action ; action
  - TXT: Il entend de Porcie.
  - XPL: La didascalie 'Il entend de Porcie' décrit une action générale du personnage, en l'occurrence l'action d'entendre quelque chose. Cela correspond à la catégorie 'action' qui est une catégorie générale pour les actions des personnages.

## 1883 || match
  - REF;PRD: action ; action
  - TXT: Puis il indiquera l'arbre dont le fruit est défendu, et dira :
  - XPL: La didascalie décrit une action du personnage, à savoir indiquer un arbre et dire quelque chose. Cette description correspond à la catégorie 'action' car elle décrit une action générale du personnage qui n'est pas spécifiquement couverte par d'autres catégories plus spécifiques.

## 1893 || match
  - REF;PRD: action ; action
  - TXT: Il boit encore.
  - XPL: La didascalie 'Il boit encore' décrit une action du personnage, qui est de boire. Cette action est couverte par la catégorie 'action' (catégorie 0), car elle n'entre pas dans les autres catégories plus spécifiques.

## 1904 || match
  - REF;PRD: action ; action
  - TXT: Elle s'affaisse dans les bras de Rosalie et glisse peu à peu jusqu'à terre.
  - XPL: La didascalie décrit une action où le personnage s'affaisse dans les bras de Rosalie et glisse jusqu'à terre. Cette description correspond à une action générale des personnages, qui inclut des verbes comme tomber et s'affaisser. Aucune autre catégorie ne décrit mieux cette action.

## 1907 || match
  - REF;PRD: action ; action
  - TXT: Regardant la figure de la madone.
  - XPL: La didascalie 'Regardant la figure de la madone' décrit une action du personnage. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 'action'.

## 1913 || match
  - REF;PRD: action ; action
  - TXT: En montrant Molière et les piédestaux.
  - XPL: La didascalie 'En montrant Molière et les piédestaux' décrit une action spécifique des personnages, à savoir montrer quelque chose. Cette action n'entre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie générale des actions des personnages.

## 1928 || match
  - REF;PRD: action ; action
  - TXT: Le greffier écrit.
  - XPL: La didascalie 'Le greffier écrit' décrit une action du personnage, à savoir écrire. Cette action ne rentre pas dans les autres catégories spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Par conséquent, elle est classée dans la catégorie générale des actions.

## 1936 || match
  - REF;PRD: action ; action
  - TXT: Il mange goulûment.
  - XPL: La didascalie 'Il mange goulûment' décrit une action spécifique du personnage, à savoir manger. Cette action n'est pas décrite par une autre catégorie plus spécifique, donc elle tombe sous la catégorie générale 'action'.

## 1944 || match
  - REF;PRD: action ; action
  - TXT: Il se met à genoux devant Monsieur Oronte.
  - XPL: La didascalie 'Il se met à genoux devant Monsieur Oronte' décrit une action spécifique du personnage, qui est de s'agenouiller. Cette action est bien couverte par la catégorie 'action' (catégorie 0), car elle implique un mouvement physique du personnage qui n'est pas spécifiquement une interaction non verbale avec un autre personnage, mais plutôt une action individuelle.

## 1948 || match
  - REF;PRD: action ; action
  - TXT: Lisant :
  - XPL: La didascalie 'Lisant :' décrit une action simple du personnage, qui est de lire. Cette action ne correspond pas spécifiquement à une entrée, une sortie, une interaction non verbale, un mouvement, une narration, une description d'objet, une mise en scène, ou une indication de destinataire. Elle ne décrit pas non plus une agression, un aparté, une manière de délivrer une réplique, ou une musique. Par conséquent, la catégorie 'action' (0) est la plus appropriée pour cette didascalie.

## 1954 || match
  - REF;PRD: action ; action
  - TXT: Tous se mettent à genoux, excepté le Juge et les Soldats.
  - XPL: La didascalie 'Tous se mettent à genoux, excepté le Juge et les Soldats' décrit une action des personnages, à savoir se mettre à genoux. Cette action n'est pas spécifiquement couverte par une autre catégorie plus précise, donc elle tombe sous la catégorie générale 'action' (catégorie 0).

## 1973 || match
  - REF;PRD: action ; action
  - TXT: Il se jette à genoux.
  - XPL: La didascalie 'Il se jette à genoux' décrit une action spécifique du personnage, qui est de s'agenouiller. Cette action ne relève pas d'une interaction non verbale avec un autre personnage, d'un déplacement spécifique, d'une entrée ou sortie de scène, ni d'une autre catégorie spécifique. Elle correspond donc à la catégorie générale des actions des personnages.

## 1991 || match
  - REF;PRD: action ; action
  - TXT: Regardant du coté opposé.
  - XPL: La didascalie 'Regardant du côté opposé' décrit une action générale du personnage, qui est de regarder. Cette action ne rentre pas spécifiquement dans les autres catégories plus spécifiques, donc elle est classée dans la catégorie 'action' (0).

## 2001 || match
  - REF;PRD: action ; action
  - TXT: Ils se mettent à table.
  - XPL: La didascalie 'Ils se mettent à table' décrit une action des personnages, à savoir s'asseoir à table. Cette action n'entre pas dans les autres catégories plus spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie générale des actions.

## 2007 || match
  - REF;PRD: action ; action
  - TXT: Regardant le chanson.
  - XPL: La didascalie 'Regardant le chanson' décrit une action du personnage, à savoir regarder. Cette action ne rentre pas dans les catégories spécifiques telles que l'agression, l'aparté, la livraison, l'entrée, la sortie, l'interaction, le mouvement, la musique, la narration, l'objet, le décor ou le destinataire. Par conséquent, elle relève de la catégorie générale des actions des personnages.

## 2014 || match
  - REF;PRD: action ; action
  - TXT: Montrant Claudine.
  - XPL: La didascalie 'Montrant Claudine' décrit une action du personnage, qui est de montrer quelqu'un. Cette action n'est pas spécifiquement couverte par d'autres catégories plus précises, donc elle correspond à la catégorie générale 'action'.

## 2017 || match
  - REF;PRD: action ; action
  - TXT: On entend de nouveau frapper à la porte du fond.
  - XPL: La didascalie 'On entend de nouveau frapper à la porte du fond' décrit une action (frapper à la porte) qui n'est pas spécifiquement couverte par d'autres catégories plus précises. Elle ne relève pas de l'agression, de l'aparté, de la délivrance, de l'entrée, de la sortie, de l'interaction non verbale, du mouvement, de la musique, de la narration, de l'objet, du décor ou du destinataire d'une réplique.

## 2023 || match
  - REF;PRD: action ; action
  - TXT: Elle ouvre la lettre.
  - XPL: La didascalie 'Elle ouvre la lettre' décrit une action simple et générale d'un personnage. Le verbe 'ouvrir' est listé dans la définition de la catégorie 'action'. Aucune autre catégorie ne décrit mieux cette action.

## 2028 || match
  - REF;PRD: action ; action
  - TXT: Àprès avoir lu.
  - XPL: La didascalie 'Àprès avoir lu' décrit une action générale du personnage, en l'occurrence l'action de lire. Cette catégorie est appropriée car elle inclut des actions telles que lire, s'asseoir, bouger, etc.

## 2030 || match
  - REF;PRD: action ; action
  - TXT: Qui a entendu les trois derniers vers de Tibère.
  - XPL: La didascalie 'Qui a entendu les trois derniers vers de Tibère' décrit une action des personnages, en l'occurrence l'acte d'écouter. Cette didascalie ne correspond pas à des catégories spécifiques comme l'entrée, la sortie, l'interaction non verbale, ou la description de la scène. Elle se rapporte à une action générale des personnages, ce qui correspond à la catégorie 'action' (catégorie 0).

## 2051 || match
  - REF;PRD: action ; action
  - TXT: II ouvre le treillage, et l'on voit la Comtesse à la place de la statue.
  - XPL: La didascalie décrit une action spécifique du personnage, à savoir ouvrir le treillage, et une révélation visuelle (voir la Comtesse à la place de la statue). Ces actions ne correspondent pas parfaitement aux autres catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. La catégorie 'action' est la plus appropriée car elle couvre des actions générales des personnages.

## 2056 || match
  - REF;PRD: action ; action
  - TXT: Il y cherche.
  - XPL: La didascalie 'Il y cherche' décrit une action du personnage, qui est de chercher quelque chose. Cette action n'est pas spécifiquement couverte par les autres catégories plus spécifiques, donc elle tombe sous la catégorie générale des actions (action).

## 2068 || match
  - REF;PRD: action ; action
  - TXT: En montrant le Chef des fugitifs et le Prélat, qui doivent être dans le fond du théâtre.
  - XPL: La didascalie décrit une action générale des personnages, à savoir 'montrer'. Cela correspond à la catégorie 'action' car le verbe 'montrer' est explicitement mentionné dans la définition de cette catégorie.

## 2069 || match
  - REF;PRD: action ; action
  - TXT: Elle se jette à ses genoux.
  - XPL: La didascalie 'Elle se jette à ses genoux' décrit une action spécifique d'un personnage. Cette action n'est pas couverte par une catégorie plus spécifique comme 'entrance' ou 'exit', et elle ne décrit pas une interaction avec un objet ou un autre personnage de manière non verbale. Elle correspond donc à la catégorie générale 'action'.

## 2074 || match
  - REF;PRD: action ; action
  - TXT: Lui montrant le café de l'Alliance.
  - XPL: La didascalie 'Lui montrant le café de l'Alliance' décrit une action générale d'un personnage montrant quelque chose à un autre personnage. Cette action ne correspond pas spécifiquement à d'autres catégories plus précises comme 'interaction', 'movement', ou 'object'. Par conséquent, elle est classée dans la catégorie 'action' (0).

## 2103 || match
  - REF;PRD: action ; action
  - TXT: Montrant Amphitryon.
  - XPL: La didascalie 'Montrant Amphitryon' décrit une action générale du personnage. Le verbe 'montrer' est explicitement mentionné dans la définition de la catégorie 0 (action) comme un exemple d'action générale.

## 2114 || match
  - REF;PRD: action ; action
  - TXT: Elle reprend la lettre et lit.
  - XPL: La didascalie 'Elle reprend la lettre et lit' décrit une action générale du personnage. Le verbe 'lire' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2123 || match
  - REF;PRD: action ; action
  - TXT: Montrant son enfant.
  - XPL: La didascalie 'Montrant son enfant' décrit une action du personnage qui ne rentre pas dans les autres catégories spécifiques. Elle correspond bien à la catégorie 'action' qui inclut des verbes comme 'montrer' parmi d'autres actions générales.

## 2133 || match
  - REF;PRD: action ; action
  - TXT: Elle regarde par la fenêtre.
  - XPL: La didascalie 'Elle regarde par la fenêtre.' décrit une action simple du personnage, qui est de regarder par la fenêtre. Cette action ne correspond à aucune des autres catégories spécifiques comme l'entrée, la sortie, l'interaction, le déplacement, etc. Elle relève donc de la catégorie générale 'action'.

## 2138 || match
  - REF;PRD: action ; action
  - TXT: Après voir lu, il dit.
  - XPL: La didascalie 'Après voir lu, il dit' décrit une action générale du personnage. Le verbe 'lire' est mentionné dans la définition de la catégorie 'action', ce qui correspond bien à cette didascalie.

## 2141 || match
  - REF;PRD: action ; action
  - TXT: Il tire le cordon de la sonnette.
  - XPL: La didascalie 'Il tire le cordon de la sonnette' décrit une action spécifique d'un personnage. Cette action n'entre pas dans les catégories plus spécifiques comme 'aggression', 'interaction', 'movement', etc. Elle correspond donc à la catégorie générale 'action' (catégorie 0), qui inclut des actions diverses comme 'sonner' parmi d'autres.

## 2143 || match
  - REF;PRD: action ; action
  - TXT: Il tombe à leurs genoux.
  - XPL: La didascalie 'Il tombe à leurs genoux' décrit une action physique du personnage, ce qui correspond à la catégorie 'action'. Les verbes comme 'tomber' et 's'agenouiller' sont explicitement mentionnés dans la définition de cette catégorie.

## 2148 || match
  - REF;PRD: action ; action
  - TXT: Montrant Antigone.
  - XPL: La didascalie 'Montrant Antigone' décrit une action générale d'un personnage montrant quelque chose ou quelqu'un. Cette action n'entre pas dans les catégories plus spécifiques comme l'entrée, la sortie, l'interaction, ou la manipulation d'objets. Elle correspond donc à la catégorie 'action'.

## 2152 || match
  - REF;PRD: action ; action
  - TXT: Après avoir regardé de tous cotés.
  - XPL: La didascalie 'Après avoir regardé de tous côtés' décrit une action générale du personnage, qui est de regarder autour de lui. Cela correspond à la catégorie 'action' (0) car il s'agit d'une action simple et générale qui ne rentre pas dans les autres catégories spécifiques.

## 2156 || match
  - REF;PRD: action ; action
  - TXT: Elle va s'asseoir à gauche.
  - XPL: La didascalie 'Elle va s'asseoir à gauche' décrit une action générale du personnage, qui est de s'asseoir. Cette action ne rentre pas dans les autres catégories spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle correspond donc à la catégorie 'action' (catégorie 0).

## 2163 || match
  - REF;PRD: action ; action
  - TXT: Regardant le tableau.
  - XPL: La didascalie 'Regardant le tableau' décrit une action générale du personnage. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2165 || match
  - REF;PRD: action ; action
  - TXT: Apercevant la malade.
  - XPL: La didascalie 'Apercevant la malade' décrit une action du personnage, en l'occurrence le fait de voir ou de regarder la malade. Cela correspond à la catégorie 'action' qui inclut des verbes comme regarder, montrer, peindre, prier, etc.

## 2169 || match
  - REF;PRD: action ; action
  - TXT: Il ouvre la deuxième lettre.
  - XPL: La didascalie 'Il ouvre la deuxième lettre' décrit une action spécifique du personnage. Bien que l'action implique un objet (la lettre), elle ne se concentre pas sur l'objet lui-même mais sur l'action d'ouvrir. Par conséquent, elle correspond mieux à la catégorie 'action' (0).

## 2194 || match
  - REF;PRD: action ; action
  - TXT: Parcourant la lettre.
  - XPL: La didascalie 'Parcourant la lettre' décrit une action spécifique du personnage, qui est de lire une lettre. Cette action ne tombe pas dans les catégories plus spécifiques comme 'agression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle correspond donc à la catégorie générale 'action' (0).

## 2199 || match
  - REF;PRD: action ; action
  - TXT: Il montre son vit.
  - XPL: La didascalie 'Il montre son vit' décrit une action spécifique du personnage, qui est de montrer une partie de son corps. Cette action n'entre pas dans les autres catégories plus spécifiques comme l'agression, l'aparté, l'interaction, etc. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 2232 || match
  - REF;PRD: action ; action
  - TXT: Il s'assoit près de Philippe.
  - XPL: La didascalie 'Il s'assoit près de Philippe.' décrit une action simple du personnage. Bien que cela puisse être considéré comme une interaction non verbale, l'action de s'asseoir est plus spécifiquement une action générale du personnage. La catégorie 'action' est donc la plus appropriée.

## 2236 || match
  - REF;PRD: action ; action
  - TXT: Il ouvre l'écrin.
  - XPL: La didascalie 'Il ouvre l'écrin' décrit une action simple d'un personnage, qui est d'ouvrir un objet. Cette action correspond à la catégorie 'action' car elle ne rentre pas dans les autres catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', etc.

## 2263 || match
  - REF;PRD: action ; action
  - TXT: Elle avale le poison.
  - XPL: La didascalie 'Elle avale le poison' décrit une action spécifique du personnage, à savoir avaler du poison. Cette action n'entre pas dans les autres catégories spécifiques telles que l'agression, l'aparté, l'entrée, la sortie, etc. Elle est donc classée dans la catégorie générale des actions (action).

## 2268 || match
  - REF;PRD: action ; action
  - TXT: Don Cosme lit.
  - XPL: La didascalie 'Don Cosme lit' décrit une action spécifique du personnage, qui est lire. Cette action ne rentre pas dans les autres catégories plus spécifiques comme l'entrée, la sortie, l'interaction non verbale, etc. Elle correspond donc à la catégorie générale des actions des personnages.

## 2284 || match
  - REF;PRD: action ; action
  - TXT: Il va aux fontaines et boit.
  - XPL: La didascalie 'Il va aux fontaines et boit.' décrit une action simple du personnage. Elle n'implique pas d'interaction avec d'autres personnages, d'entrée ou de sortie, ni de déplacement spécifique. Elle correspond donc à la catégorie 'action' (0), car elle décrit une action générale du personnage.

## 2288 || match
  - REF;PRD: action ; action
  - TXT: Il se lève ainsi que sa soeur.
  - XPL: La didascalie 'Il se lève ainsi que sa soeur' décrit une action des personnages, en l'occurrence se lever. Cette action ne correspond à aucune des autres catégories spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle relève donc de la catégorie générale des actions des personnages.

## 2292 || match
  - REF;PRD: action ; action
  - TXT: Elle montre le banc de pierre.
  - XPL: La didascalie 'Elle montre le banc de pierre' décrit une action simple du personnage. Le verbe 'montrer' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2311 || match
  - REF;PRD: action ; action
  - TXT: Elle tombe sur Barsine.
  - XPL: La didascalie 'Elle tombe sur Barsine' décrit une action physique du personnage, à savoir tomber. Cette action n'est pas spécifiquement une interaction non verbale avec un autre personnage, ni une entrée ou une sortie, ni une manipulation d'objet. Elle correspond donc à la catégorie générale des actions (action).

## 2315 || match
  - REF;PRD: action ; action
  - TXT: Il montre son pouce.
  - XPL: La didascalie 'Il montre son pouce' décrit une action du personnage. Elle ne rentre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', 'toward', 'aggression', 'aparte', ou 'delivery'. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 2343 || match
  - REF;PRD: action ; action
  - TXT: Apercevant Barberin.
  - XPL: La didascalie 'Apercevant Barberin' décrit une action du personnage qui regarde ou voit quelque chose. Cela correspond à la catégorie 'action' car elle décrit une action générale du personnage qui n'est pas spécifiquement couverte par d'autres catégories plus précises.

## 2348 || match
  - REF;PRD: action ; action
  - TXT: Regardant la statue aux pieds de laquelle Bécarre est resté, et l'admirant.
  - XPL: La didascalie décrit une action des personnages, spécifiquement 'regardant' et 'admirant' une statue. Ces actions ne sont pas des interactions non verbales avec d'autres personnages (catégorie 6), mais des actions individuelles. La catégorie 0 (action) est donc la plus appropriée.

## 2358 || match
  - REF;PRD: action ; action
  - TXT: S'asseyant sur une chaise près de la table à gauche.
  - XPL: La didascalie 'S'asseyant sur une chaise près de la table à gauche' décrit une action spécifique du personnage, qui est de s'asseoir. Cette action ne rentre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 2372 || match
  - REF;PRD: action ; action
  - TXT: Regard à la montre.
  - XPL: La didascalie 'Regard à la montre' décrit une action du personnage, qui est de regarder sa montre. Cette action n'entre pas dans les catégories plus spécifiques comme 'interaction', 'movement', ou 'object'. Elle correspond donc à la catégorie générale 'action' (catégorie 0).

## 2390 || match
  - REF;PRD: action ; action
  - TXT: Montrant la Baronne.
  - XPL: La didascalie 'Montrant la Baronne' décrit une action du personnage, qui est de montrer quelqu'un. Cette action ne rentre pas spécifiquement dans les autres catégories plus spécifiques, donc elle est classée dans la catégorie générale 'action'.

## 2401 || match
  - REF;PRD: action ; action
  - TXT: Ici, Clarice les voit de sa fenêtre ; et Lucrèce, avec Isabelle, les voit aussi de la sienne.
  - XPL: La didascalie 'Ici, Clarice les voit de sa fenêtre ; et Lucrèce, avec Isabelle, les voit aussi de la sienne.' décrit une action des personnages, spécifiquement l'action de voir quelque chose. Cette action n'entre pas dans les catégories plus spécifiques comme 'interaction' ou 'movement', donc elle est classée dans la catégorie générale 'action'.

## 2411 || match
  - REF;PRD: action ; action
  - TXT: Il relit l'adresse.
  - XPL: La didascalie 'Il relit l'adresse' décrit une action spécifique du personnage, qui est de relire une adresse. Cette action n'entre pas dans les autres catégories plus spécifiques comme 'interaction', 'movement', 'entrance', 'exit', etc. Elle correspond donc à la catégorie générale 'action'.

## 2420 || match
  - REF;PRD: action ; action
  - TXT: Il aperçoit Nicodon.
  - XPL: La didascalie 'Il aperçoit Nicodon' décrit une action simple du personnage qui regarde ou voit quelqu'un. Cette action n'implique pas de violence, d'entrée, de sortie, de déplacement, de musique, de narration, d'objet, de décor, ou de destinataire d'une réplique. Elle ne décrit pas non plus comment une réplique est interprétée ou une interaction non verbale spécifique. Par conséquent, elle correspond à la catégorie générale des actions des personnages.

## 2424 || match
  - REF;PRD: action ; action
  - TXT: Il se jette dans un fauteuil.
  - XPL: La didascalie 'Il se jette dans un fauteuil' décrit une action du personnage, à savoir s'asseoir dans un fauteuil de manière brusque. Cette action ne rentre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle correspond donc à la catégorie générale 'action'.

## 2426 || match
  - REF;PRD: action ; action
  - TXT: Il montre le mari de la Vieille.
  - XPL: La didascalie 'Il montre le mari de la Vieille' décrit une action générale du personnage, qui est de montrer quelqu'un. Cette action n'entre pas dans une catégorie plus spécifique comme l'interaction non verbale (catégorie 6) ou le déplacement (catégorie 7), donc la catégorie 'action' (catégorie 0) est la plus appropriée.

## 2429 || match
  - REF;PRD: action ; action
  - TXT: Il commence à lire le billet.
  - XPL: La didascalie 'Il commence à lire le billet.' décrit une action générale du personnage. Le verbe 'lire' est explicitement mentionné comme faisant partie de la catégorie 'action'.

## 2453 || match
  - REF;PRD: action ; action
  - TXT: D'Orfeuil est resté un moment étourdi de sa chute ; il se relève.
  - XPL: La didascalie 'D'Orfeuil est resté un moment étourdi de sa chute ; il se relève.' décrit une action du personnage D'Orfeuil. Il est mentionné qu'il est étourdi et qu'il se relève, ce qui correspond à la catégorie 'action' (0).

## 2470 || match
  - REF;PRD: action ; action
  - TXT: Ils boivent de nouveau.
  - XPL: La didascalie 'Ils boivent de nouveau' décrit une action des personnages, à savoir boire. Cette action est explicitement mentionnée dans la définition de la catégorie 'action' (catégorie 0).

## 2471 || match
  - REF;PRD: action ; action
  - TXT: En se retournant, elle aperçoit Don Juan sur le seuil de la porte.
  - XPL: La didascalie décrit une action du personnage, à savoir 'En se retournant, elle aperçoit Don Juan sur le seuil de la porte.' Cette description correspond à la catégorie 'action' car elle implique une action physique (se retourner) et une observation (apercevoir Don Juan).

## 2472 || match
  - REF;PRD: action ; action
  - TXT: Montrant Nadine.
  - XPL: La didascalie 'Montrant Nadine' décrit une action générale du personnage, qui est de montrer quelqu'un. Cette action ne rentre pas dans les autres catégories spécifiques comme l'entrée, la sortie, l'interaction non verbale, etc. Elle est donc classée dans la catégorie 'action'.

## 2486 || match
  - REF;PRD: action ; action
  - TXT: Apercevant son fils.
  - XPL: La didascalie 'Apercevant son fils' décrit une action du personnage, qui est de voir ou de remarquer son fils. Cette action ne correspond pas spécifiquement à d'autres catégories comme l'entrée, la sortie, l'interaction non verbale, le mouvement, etc. Par conséquent, elle est classée dans la catégorie générale 'action'.

## 2519 || match
  - REF;PRD: action ; action
  - TXT: Il s'assied dans un fauteuil.
  - XPL: La didascalie 'Il s'assied dans un fauteuil.' décrit une action simple d'un personnage. Elle ne correspond pas à une entrée ou une sortie, ni à une interaction avec un objet ou une autre personne. Elle ne décrit pas non plus une action violente, une musique, une narration, ou un aparté. Elle ne spécifie pas non plus un destinataire de réplique. Par conséquent, elle correspond à la catégorie 'action' (catégorie 0).

## 2525 || match
  - REF;PRD: action ; action
  - TXT: S'asseyant sur le canapé n° 1.
  - XPL: La didascalie 'S'asseyant sur le canapé n° 1' décrit une action du personnage, en l'occurrence s'asseoir. Cette action ne correspond pas spécifiquement à une entrée ou sortie de scène, ni à une interaction non verbale avec un autre personnage, ni à une description de la scène ou du lieu. Elle ne relève pas non plus de l'agression, de l'aparté, de la délivrance, de la musique, de la narration, ou de l'objet. Par conséquent, la catégorie 'action' (catégorie 0) est la plus appropriée.

## 2537 || match
  - REF;PRD: action ; action
  - TXT: Cherchant.
  - XPL: La didascalie 'Cherchant' décrit une action générale du personnage. Selon la définition de la catégorie 0 (action), elle inclut des verbes comme chercher, regarder, montrer, parmi d'autres. 'Cherchant' correspond parfaitement à cette catégorie.

## 2548 || match
  - REF;PRD: action ; action
  - TXT: Il la cherche de la main sans tourner la tête.
  - XPL: La didascalie 'Il la cherche de la main sans tourner la tête' décrit une action générale du personnage, à savoir chercher quelqu'un avec la main. Cette action n'entre pas dans les catégories spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle correspond donc à la catégorie générale 'action'.

## 2562 || match
  - REF;PRD: action ; action
  - TXT: Elle frappe à la porte en dehors.
  - XPL: La didascalie 'Elle frappe à la porte en dehors' décrit une action spécifique du personnage. Bien que 'frapper' puisse parfois être associé à l'agression, dans ce contexte, il s'agit simplement d'une action physique sans connotation violente. La catégorie 'action' (0) est donc la plus appropriée.

## 2565 || match
  - REF;PRD: action ; action
  - TXT: Camille s'assoit.
  - XPL: La didascalie 'Camille s'assoit' décrit une action simple du personnage Camille. Cette action n'entre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', etc. Elle correspond à la catégorie générale des actions des personnages, qui inclut des verbes comme 's'asseoir'.

## 2570 || match
  - REF;PRD: action ; action
  - TXT: Montrant les Muses.
  - XPL: La didascalie 'Montrant les Muses' décrit une action générale des personnages, à savoir montrer quelque chose. Cette action n'est pas spécifiquement liée à une autre catégorie plus précise, donc elle tombe sous la catégorie 'action'.

## 2582 || match
  - REF;PRD: action ; action
  - TXT: Guillot s'assìed.
  - XPL: La didascalie 'Guillot s'assìed' décrit une action simple du personnage. S'asseoir est une action générale qui ne rentre pas dans les autres catégories spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie 'action'.

## 2583 || match
  - REF;PRD: action ; action
  - TXT: Après avoir encore bu, il dit :
  - XPL: La didascalie 'Après avoir encore bu, il dit :' décrit une action du personnage, à savoir boire. Cette action est couverte par la catégorie générale 'action' qui inclut des verbes comme boire.

## 2597 || match
  - REF;PRD: action ; action
  - TXT: Plusieurs groupes de Bergers et de Bergères jouant à divers jeux.
  - XPL: La didascalie décrit des actions des personnages (plusieurs groupes de Bergers et de Bergères jouant à divers jeux), ce qui correspond à la catégorie 'action'. Les verbes 'jouer' et 'faire des jeux' sont des actions générales qui ne sont pas spécifiquement couvertes par d'autres catégories.

## 2600 || match
  - REF;PRD: action ; action
  - TXT: Elle semble se mirer dans un ruisseau en arrangeant les fleurs dans ses cheveux.
  - XPL: La didascalie 'Elle semble se mirer dans un ruisseau en arrangeant les fleurs dans ses cheveux.' décrit une action spécifique du personnage, qui est de se mirer dans un ruisseau et d'arranger des fleurs dans ses cheveux. Ces actions ne rentrent pas dans les catégories plus spécifiques comme 'interaction', 'movement', 'entrance', 'exit', 'aggression', etc. Par conséquent, la catégorie générale 'action' est la plus appropriée.

## 2605 || match
  - REF;PRD: action ; action
  - TXT: Il l'ôte et lit :
  - XPL: La didascalie 'Il l'ôte et lit :' décrit une action générale du personnage qui ôte quelque chose et lit. Cette action n'entre pas dans une catégorie plus spécifique comme 'entrance', 'exit', 'interaction', ou 'movement'. Elle correspond donc à la catégorie 'action' (0).

## 2606 || match
  - REF;PRD: action ; action
  - TXT: Il montre Florange.
  - XPL: La didascalie 'Il montre Florange' décrit une action générale du personnage, qui est de montrer quelque chose ou quelqu'un. Le verbe 'montrer' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2607 || match
  - REF;PRD: action ; action
  - TXT: Il saute.
  - XPL: La didascalie 'Il saute.' décrit une action simple d'un personnage. Cette action ne correspond à aucune des autres catégories spécifiques, donc elle tombe sous la catégorie générale 'action' (catégorie 0).

## 2608 || match
  - REF;PRD: action ; action
  - TXT: Il lit un des billets que Livie lui a rendus.
  - XPL: La didascalie 'Il lit un des billets que Livie lui a rendus' décrit une action générale du personnage, à savoir lire un billet. Cette action ne correspond pas spécifiquement à une autre catégorie plus précise, donc elle tombe dans la catégorie générale 'action' (catégorie 0).

## 2616 || match
  - REF;PRD: action ; action
  - TXT: Elle s'étend dans un fauteuil.
  - XPL: La didascalie 'Elle s'étend dans un fauteuil' décrit une action du personnage. Elle ne correspond pas à une entrée ou sortie (catégories 4 et 5), ni à une interaction non verbale (catégorie 6), ni à un déplacement (catégorie 7). Elle ne décrit pas non plus une interaction avec un objet (catégorie 10) ou une description de la scène (catégorie 11). Par conséquent, la catégorie 0 (action) est la plus appropriée car elle est une action générale du personnage.

## 2623 || match
  - REF;PRD: action ; action
  - TXT: La pendule sonne six heures.
  - XPL: La didascalie 'La pendule sonne six heures' décrit une action spécifique (la pendule sonne) qui n'est pas couverte par les autres catégories. Elle n'implique pas de mouvement de personnage, d'interaction, de musique, de narration, d'objet, de décor, ou d'autre élément spécifique. Elle relève donc de la catégorie générale des actions.

## 2634 || match
  - REF;PRD: action ; action
  - TXT: Il lit la lettre bas.
  - XPL: La didascalie 'Il lit la lettre bas' décrit une action spécifique du personnage, qui est de lire une lettre à voix basse. Cette action ne rentre pas dans une catégorie plus spécifique comme 'interaction', 'movement', ou 'aggression'. Elle correspond donc à la catégorie générale 'action'.

## 2644 || match
  - REF;PRD: action ; action
  - TXT: Il appuie en lisant.
  - XPL: La didascalie 'Il appuie en lisant.' décrit une action générale du personnage, à savoir lire tout en appuyant sur quelque chose. Cette description ne correspond pas à une catégorie plus spécifique comme 'aggression', 'aparte', 'delivery', etc. Elle relève donc de la catégorie générale 'action' (catégorie 0).

## 2665 || match
  - REF;PRD: action ; action
  - TXT: Il goûte.
  - XPL: La didascalie 'Il goûte.' décrit une action générale du personnage, qui est de goûter quelque chose. Cette action ne rentre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Elle est donc classée dans la catégorie 'action' (0).

## 2670 || match
  - REF;PRD: action ; action
  - TXT: Montrant Crispin.
  - XPL: La didascalie 'Montrant Crispin' décrit une action générale du personnage, qui est de montrer quelqu'un. Cette action ne rentre pas dans les autres catégories spécifiques comme l'entrée, la sortie, l'interaction non verbale, etc. Elle correspond donc à la catégorie générale des actions.

## 2672 || match
  - REF;PRD: action ; action
  - TXT: Montrant Trissotin.
  - XPL: La didascalie 'Montrant Trissotin' décrit une action du personnage qui montre quelqu'un ou quelque chose. Cette action ne correspond pas à une entrée, une sortie, une interaction non verbale, un déplacement, une musique, une narration, un objet, un décor, ou un destinataire de réplique. Elle ne décrit pas non plus une agression, un aparté, ou une manière de délivrer une réplique. Par conséquent, elle appartient à la catégorie générale des actions des personnages.

## 2688 || match
  - REF;PRD: action ; action
  - TXT: L'examinant encore.
  - XPL: La didascalie 'L'examinant encore' décrit une action du personnage qui examine quelque chose ou quelqu'un. Cette action ne rentre pas dans une des catégories plus spécifiques comme 'interaction', 'movement', ou 'delivery'. Elle est donc classée dans la catégorie générale 'action'.

## 2690 || match
  - REF;PRD: action ; action
  - TXT: Regardant sa montre.
  - XPL: La didascalie 'Regardant sa montre' décrit une action générale du personnage. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2706 || match
  - REF;PRD: action ; action
  - TXT: En se regardant.
  - XPL: La didascalie 'En se regardant' décrit une action générale des personnages, qui est le fait de se regarder. Cette action ne rentre pas spécifiquement dans les autres catégories plus spécifiques, donc la catégorie 'action' (0) est la plus appropriée.

## 2707 || match
  - REF;PRD: action ; action
  - TXT: Montrant Brécourt.
  - XPL: La didascalie 'Montrant Brécourt' décrit une action spécifique du personnage, à savoir montrer quelque chose ou quelqu'un. Cette action ne rentre pas dans les autres catégories plus spécifiques comme 'entrance', 'exit', 'interaction', 'movement', etc. Elle est donc classée dans la catégorie générale 'action' (catégorie 0).

## 2715 || match
  - REF;PRD: action ; action
  - TXT: Il regarde autour de lui, et vois du sang.
  - XPL: La didascalie décrit une action du personnage qui regarde autour de lui et voit du sang. Cela correspond à la catégorie 'action' car il s'agit d'une action générale du personnage qui ne rentre pas dans les autres catégories spécifiques.

## 2731 || match
  - REF;PRD: action ; action
  - TXT: Scarron continue d'écrire.
  - XPL: La didascalie 'Scarron continue d'écrire' décrit une action spécifique du personnage Scarron, qui est l'acte d'écrire. Cette action ne rentre pas dans les catégories plus spécifiques comme 'aggression', 'aparte', 'delivery', 'entrance', 'exit', 'interaction', 'movement', 'music', 'narration', 'object', 'setting', ou 'toward'. Par conséquent, elle correspond le mieux à la catégorie générale 'action' (catégorie 0).

## 2735 || match
  - REF;PRD: action ; action
  - TXT: Agar s'assied sur un rocher à côté de son enfant.
  - XPL: La didascalie 'Agar s'assied sur un rocher à côté de son enfant' décrit une action simple d'un personnage, qui est de s'asseoir. Cette action n'entre pas dans les catégories spécifiques comme l'entrée, la sortie, l'interaction non verbale, ou la manipulation d'objets. Par conséquent, elle correspond à la catégorie générale des actions des personnages.

## 2758 || match
  - REF;PRD: action ; action
  - TXT: On frappe de nouveau.
  - XPL: La didascalie 'On frappe de nouveau' décrit une action des personnages, spécifiquement l'action de frapper. Cette action n'entre pas dans les autres catégories spécifiques telles que l'agression, l'entrée, la sortie, ou l'interaction non verbale. Par conséquent, elle est classée dans la catégorie générale 'action'.

## 2761 || match
  - REF;PRD: action ; action
  - TXT: Il veut lire.
  - XPL: La didascalie 'Il veut lire' décrit une action du personnage, qui est de lire. Cette action n'est pas spécifiquement couverte par les autres catégories, donc elle tombe sous la catégorie générale 'action'.

## 2762 || match
  - REF;PRD: action ; action
  - TXT: Regardant.
  - XPL: La didascalie 'Regardant' décrit une action du personnage, qui est de regarder. Cette action n'est pas spécifiquement couverte par une autre catégorie plus précise, donc elle tombe sous la catégorie générale 'action'.

## 2772 || match
  - REF;PRD: action ; action
  - TXT: Observant Terville.
  - XPL: La didascalie 'Observant Terville' décrit une action du personnage qui observe quelqu'un ou quelque chose. Cette action n'est pas spécifiquement couverte par les autres catégories, donc elle tombe dans la catégorie générale 'action'.

## 2773 || match
  - REF;PRD: action ; action
  - TXT: Elle repeint.
  - XPL: La didascalie 'Elle repeint' décrit une action simple du personnage, qui est de repeindre. Cette action ne rentre pas dans les autres catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie 'action' (catégorie 0).

## 2777 || match
  - REF;PRD: action ; action
  - TXT: Regardent sa montre.
  - XPL: La didascalie 'Regardent sa montre' décrit une action des personnages. Elle n'implique pas de mouvement spécifique, d'entrée ou de sortie, ni d'interaction verbale ou non verbale avec d'autres personnages. Elle ne décrit pas non plus un objet de manière spécifique, mais plutôt l'action de regarder un objet. Cela correspond donc à la catégorie 'action' (0).

## 2778 || match
  - REF;PRD: action ; action
  - TXT: Elle cherche encore.
  - XPL: La didascalie 'Elle cherche encore' décrit une action générale du personnage. Le verbe 'chercher' est explicitement mentionné dans la définition de la catégorie 0 (action), ce qui en fait la catégorie la plus appropriée.
...
## 2781 || match
  ...
  - XPL: La didascalie décrit une action spécifique du personnage, à savoir montrer les deux premiers doigts de chaque main et les croiser. Cette action ne correspond pas à une interaction verbale (catégorie 6), ni à une entrée ou sortie (catégories 4 et 5), ni à une interaction avec un objet (catégorie 10). Elle ne décrit pas non plus une agression (catégorie 1) ou une délivrance vocale (catégorie 3). Par conséquent, la catégorie 'action' (catégorie 0) est la plus appropriée.

## 2790 || match
  - REF;PRD: action ; action
  - TXT: On entend frapper à la porte.
  - XPL: La didascalie 'On entend frapper à la porte.' décrit une action spécifique qui se produit dans la scène, à savoir le fait d'entendre quelqu'un frapper à la porte. Cela correspond à la catégorie 'action' car elle décrit une action qui se produit dans la scène sans être spécifiquement liée à une autre catégorie plus précise.

## 2796 || match
  - REF;PRD: action ; action
  - TXT: En montrant Scanderberg.
  - XPL: La didascalie 'En montrant Scanderberg' décrit une action générale d'un personnage, qui est de montrer quelque chose ou quelqu'un. Cela correspond à la catégorie 'action' qui inclut des verbes comme 'montrer'.

## 2806 || match
  - REF;PRD: action ; action
  - TXT: Montrant Lépine.
  - XPL: La didascalie 'Montrant Lépine' décrit une action générale du personnage, qui est de montrer quelque chose ou quelqu'un. Cette action ne correspond pas spécifiquement à une autre catégorie plus précise, donc elle tombe dans la catégorie générale des actions.

## 2812 || match
  - REF;PRD: action ; action
  - TXT: Il peint.
  - XPL: La didascalie 'Il peint.' décrit une action du personnage, qui est de peindre. Cette action ne rentre pas dans les autres catégories spécifiques comme l'agression, l'aparté, l'entrée, la sortie, etc. Elle correspond donc à la catégorie générale des actions des personnages.

## 2814 || match
  - REF;PRD: action ; action
  - TXT: Elle mange avidement.
  - XPL: La didascalie 'Elle mange avidement' décrit une action du personnage, qui est de manger. Cette action est couverte par la catégorie 'action', qui inclut des verbes comme manger, boire, dormir, etc.

## 2819 || match
  - REF;PRD: action ; action
  - TXT: Il voit venir la Princesse.
  - XPL: La didascalie 'Il voit venir la Princesse' décrit une action du personnage, en l'occurrence l'action de voir. Cette catégorie est appropriée car elle couvre les actions générales des personnages, et aucune autre catégorie ne décrit spécifiquement l'action de voir.

## 2833 || match
  - REF;PRD: action ; action
  - TXT: Il lui fait voir le lot.
  - XPL: La didascalie 'Il lui fait voir le lot' décrit une action générale où un personnage montre quelque chose à un autre personnage. Cette action est bien couverte par la catégorie 'action' (catégorie 0), qui inclut des verbes comme montrer, regarder, parmi d'autres actions générales.

## 2843 || match
  - REF;PRD: action ; action
  - TXT: À genoux.
  - XPL: La didascalie 'À genoux' décrit une action physique du personnage, qui est de s'agenouiller. Cette action est couverte par la catégorie 'action' (catégorie 0), car elle correspond à une action générale des personnages.

## 2848 || match
  - REF;PRD: action ; action
  - TXT: Montrant les anciens Sénateurs.
  - XPL: La didascalie 'Montrant les anciens Sénateurs' décrit une action des personnages, spécifiquement l'action de montrer. Cela correspond à la catégorie 'action' (catégorie 0), qui inclut des verbes comme montrer, regarder, peindre, etc.

## 2849 || match
  - REF;PRD: action ; action
  - TXT: Lui montrant ce qui est écrit au bas du mémoire.
  - XPL: La didascalie 'Lui montrant ce qui est écrit au bas du mémoire' décrit une action spécifique d'un personnage montrant quelque chose à un autre personnage. Cette action est bien décrite par la catégorie 'action' (0), car elle implique une action directe et spécifique sans être une interaction non verbale (catégorie 6) ou une manipulation d'objet (catégorie 10).

## 2863 || match
  - REF;PRD: action ; action
  - TXT: Se laissant tomber à genoux.
  - XPL: La didascalie 'Se laissant tomber à genoux' décrit une action spécifique du personnage. Cette action ne correspond pas à une entrée ou sortie de scène, ni à une interaction non verbale, ni à une narration ou à une description d'objet ou de lieu. Elle décrit simplement une action physique du personnage, ce qui correspond à la catégorie 'action'.

## 2880 || match
  - REF;PRD: action ; action
  - TXT: En montrant les acteurs et actrices tragiques.
  - XPL: La didascalie 'En montrant les acteurs et actrices tragiques' décrit une action des personnages, à savoir montrer quelque chose. Le verbe 'montrer' est explicitement mentionné dans la définition de la catégorie 'action'.

## 2888 || match
  - REF;PRD: action ; action
  - TXT: On frappe à la porte.
  - XPL: La didascalie 'On frappe à la porte' décrit une action spécifique effectuée par un personnage. Elle ne correspond pas à une entrée ou une sortie de scène, ni à une interaction non verbale ou à un déplacement. Elle ne décrit pas non plus un objet, une narration, une musique, ou un aparté. Par conséquent, elle tombe dans la catégorie générale des actions des personnages.

## 2889 || match
  - REF;PRD: action ; action
  - TXT: En gesticulant il brouille tout l'écheveau.
  - XPL: La didascalie 'En gesticulant il brouille tout l'écheveau' décrit une action générale du personnage. Le verbe 'gesticuler' et l'action de 'brouiller l'écheveau' ne rentrent pas dans les catégories plus spécifiques comme 'aggression', 'entrance', 'exit', ou 'interaction'. Par conséquent, elle est classée dans la catégorie 'action' (0).

## 2890 || match
  - REF;PRD: action ; action
  - TXT: Il se jette aux genoux de Léonore.
  - XPL: La didascalie 'Il se jette aux genoux de Léonore' décrit une action spécifique du personnage, qui est de s'agenouiller devant Léonore. Cette action est bien décrite par la catégorie 'action' (catégorie 0), qui inclut des verbes comme 's'agenouiller'.

## 2893 || match
  - REF;PRD: action ; action
  - TXT: Il lit l'affiche.
  - XPL: La didascalie 'Il lit l'affiche' décrit une action spécifique du personnage, à savoir lire une affiche. Cette action n'est pas couverte par une catégorie plus spécifique parmi celles fournies, donc elle correspond à la catégorie générale 'action'.

## 2895 || match
  - REF;PRD: action ; action
  - TXT: En regardant les cartes.
  - XPL: La didascalie 'En regardant les cartes' décrit une action des personnages. Le verbe 'regarder' est explicitement mentionné dans la définition de la catégorie 0 (action), ce qui en fait la catégorie la plus appropriée.

## 2908 || match
  - REF;PRD: action ; action
  - TXT: Montrant Évelina.
  - XPL: La didascalie 'Montrant Évelina' décrit une action du personnage, qui est de montrer quelqu'un. Cette action n'entre pas dans les catégories plus spécifiques comme 'entrance', 'exit', 'interaction', etc. Elle correspond donc à la catégorie générale 'action'.

## 2909 || match
  - REF;PRD: action ; action
  - TXT: Ils se lèvent de table.
  - XPL: La didascalie 'Ils se lèvent de table.' décrit une action des personnages sans entrer dans les détails d'une interaction spécifique ou d'un mouvement particulier. Elle correspond à la catégorie 'action' car elle décrit une action générale des personnages.

## 2914 || match
  - REF;PRD: action ; action
  - TXT: Apercevant le Marquis.
  - XPL: La didascalie 'Apercevant le Marquis' décrit une action du personnage qui est en train de voir ou de regarder quelqu'un. Cela correspond à la catégorie 'action' (0) car c'est une action générale du personnage qui n'est pas spécifiquement couverte par d'autres catégories plus précises.

## 2916 || match
  - REF;PRD: action ; action
  - TXT: Alors Adam lèvera la main et montrera le fruit défendu, en disant :
  - XPL: La didascalie 'Alors Adam lèvera la main et montrera le fruit défendu, en disant :' décrit une action spécifique que le personnage Adam effectue. Cette action implique de lever la main et de montrer un objet, ce qui correspond à la définition de la catégorie 'action'. Les verbes 'lever' et 'montrer' sont directement liés à cette catégorie.
